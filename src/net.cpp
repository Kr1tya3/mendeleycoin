...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Mendeleycoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"mendeleycointools.com", "dnsseed.mendeleycointools.com"},
    {"mendeleycoinpool.org", "dnsseed.mendeleycoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"mendeleycointools.com", "testnet-seed.mendeleycointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Mendeleycoin is probably already running."), addrBind.ToString().c_str());
        else
